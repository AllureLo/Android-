package com.callenld.demo.adapter;
...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.ivDel.setOnClickListener(view -> {
                if (mDeleteClickListener != null) {
                    ...
                    mDeleteClickListener.onDeleteClick(index, view);
                }
            });
            LocalMedia media = list.get(position);
            int mimeType = media.getMimeType();
            String path = "";
            boolean isTrue=(media.isCompressed() || (media.isCut()) && media.isCompressed());
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                RequestOptions options = new RequestOptions()
                        .centerCrop()
                        .placeholder(R.color.colorImage)
